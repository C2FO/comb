 ...
 * @property {Boolean} isTrace true if this Loggers level is DEBUG
 * @property {Boolean} isInfo true if this Loggers level is DEBUG
 * @property {Boolean} isWarn true if this Loggers level is DEBUG
 * @property {Boolean} isError true if this Loggers level is DEBUG
 * @property {Boolean} isFatal true if this Loggers level is DEBUG
 * @property {Boolean} isOff true if this Loggers level is DEBUG
