...
var Appender = (exports = module.exports = define(null, {
			instance : {
				constructor : function(options) {
					options = options || {};
					this.__name = options.name || "appender";
					this.__pattern = options.pattern || "[{[yyyy-MM-ddTHH:mm:ss:SSS (z)]timeStamp}] {[- 5]levelName} {[-20]name} - {message}";
					this.__level = (options.level && Level.toLevel(options.level)) || Level.INFO;
				},
