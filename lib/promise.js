...
Promise = define(null, {
    instance: {
        ...
        /**
         * Promise object used to provide separation of success and error resolution paths for async operations.
         *
         * @example
         * var myFunc = function(){
         ...
         * will be an error, or null if no error occurred. The other arguments will
         ...
         * ```
         *
         * If you do not provide an `errback` for each chain then it will be propagated to the final promise
         *
         *
         * ```
         * new Promise()
...
/**
 * Works just like {@link comb.Promise#chain} method, allowing you to propagate results from one function to another.
 * This is different than {@link comb.serial} in that it propagates results from one promise to the next, where
...
function wait(args, fn) {
    ...
    return function waiter() {
        var waiterArgs = arguments;
        if (!resolved) {
            return p.chain(function () {
                resolved = true;
                p = null;
                return fn.apply(this, waiterArgs);
            }.bind(this));
        } else {
            return when(fn.apply(this, waiterArgs));
        }
    };
}
