 ...
 * @returns {Object} the merged object
 */
comb.deepMerge = function combDeepMerge(obj, props) {
    if (!obj) {
        obj = {};
    }
    for (var i = 1, l = arguments.length; i < l; i++) {
 ...
 */
comb.extend = function extend(parent, extend) {
    var proto = parent.prototype || parent;
    return merge(proto, extend);
};
 ...
 */
comb.isObject = function isObject(obj) {
    var undef;
 ...
 */
comb.isHash = function isHash(obj) {
 ...
 */
comb.isEmpty = function isEmpty(object) {
 ...
 * @return {Boolean}
 */
comb.deepEqual = function deepEqual(o1, o2) {
