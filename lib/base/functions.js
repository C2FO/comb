 ...
 * @param {Anything} [args] optional args to pass to the callback
 *
 * @returns {Function} the hitched function
 */
exports.hitch = function(scope, method, args) {
 ...
 */
exports.partial = function(method, args) {
 ...
 * */
exports.curry = function(depth, cb, scope) {
    var f;
    if (scope) {
        f = exports.hitch(scope, cb);
    } else {
        f = cb;
    }
    if (depth) {
