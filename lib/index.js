 ...
 * <h2>Why?</h2>
 *
 * <p>If you're like us its fun to find new modules to use but often wish you didn&rsquo;t have to sift through NPM registry
 * or the node modules page to find what you need.</p>
 *
 * <p> So&hellip;.</p>
 *
 * <p>We created a library of things we use often, or common utilities that are used by our other APIs.</p>
 *
 * <h2>Highlights</h2>
 *
 * <ul>
 ...
 * <li>Access to your class level properties within an instance</li>
 ...
 * </ul>
 * </li>
 * <li>All appenders can be used with custom levels, separately, or all together.</li>
