...
//Super of other classes
    it.should("determine if something is a String", function () {
        ...
        assert.isTrue(comb.isString(String("")));
        ...
        assert.isTrue(comb("").isString());
        assert.isTrue(comb(String("")).isString());
    ...
    it.describe("comb.string", function (it) {
        ...
        it.describe(".format", function (it) {
            it.should("format strings properly", function () {
                ...
                assert.equal(comb.string.format("%+d, %+d, %10d, %-10d, %-+#10d, %10d", 1, -2, 1, 2, 3, 100000000000), "+1, -2,          1, 2         , +3########, 1000000000");
                ...
                assert.equal(comb("%+d, %+d, %10d, %-10d, %-+#10d, %10d").format(1, -2, 1, 2, 3, 100000000000), "+1, -2,          1, 2         , +3########, 1000000000");
            ...
            it.should("format numbers", function () {
                ...
                assert.equal(comb.string.format('%.2d', 10), "10.00");
