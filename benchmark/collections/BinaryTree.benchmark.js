...
var testInserts = function(arr, tree) {
    ...
    printStats("BINARYTREE", "INSERTION", start, end);
};
...
var testLookUps = function(arr, tree) {
    ...
    printStats("BINARYTREE", "LOOK UP", start, end);
};
...
var testDeletion = function(arr, tree) {
    ...
    printStats("BINARYTREE", "DELETION", start, end);
};

var test = function() {
     var testArr = [], testTree = new BinaryTree();
